-- Registers ent_bombin_support_heli in the Q menu spawnlist
-- Also adds a context menu panel for ConVar tuning
...
-- ============================================================
-- SPAWN ON CLICK — places heli above player look position
-- ============================================================

hook.Add("SpawnMenuOpen", "BombinSupportHeli_SpawnHook", function() end)

-- Entity spawns via right-click → Spawn on the content icon above.
-- The entity is non-spawnable via prop menu intentionally (ENT.Spawnable = false).
-- Server-side spawn is handled via the NPC caller system.
-- For manual testing use the console command below.
